...
#define CREATE_SYSFS_DEVICE_READ_FUNCTION(__fname)                                                 \
	static ssize_t __fname##_sysfs_device(struct device *dev, struct device_attribute *attr,   \
					      char *buf)                                           \
	{                                                                                          \
		return __fname(buf);                                                               \
	}
...
#define CREATE_SYSFS_KOBJECT_READ_FUNCTION(__fname)                                                \
	static ssize_t __fname##_sysfs_kobject(struct kobject *dev, struct kobj_attribute *attr,   \
					       char *buf)                                          \
	{                                                                                          \
		return __fname(buf);                                                               \
	}
